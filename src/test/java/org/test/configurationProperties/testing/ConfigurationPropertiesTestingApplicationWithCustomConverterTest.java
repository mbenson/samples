 ...
 * </pre>
 *
 * Here we show that the ConversionService approach works.
 */
...
@IntegrationTest({ "org.test.easy[0]=foo", "org.test.easy[1]=bar",
		...
		"org.test.customConverter=true" })
public class ConfigurationPropertiesTestingApplicationWithCustomConverterTest extends
